                    ...
                    if (userChoice2.equals("1")) {
                        ...
                        if (dataBaseSystem.searchForUser(client)) {
                            ...
                            if (clientChoice1 == 1){
                                ...
                                System.out.println(clientRide.getPrice());
                                System.out.println("press 1 to accept "+"\n"+"press any else key to reject");
                                int choose =scan.nextInt();

                                if(choose==1)
                                {
                                    dataBaseSystem.rideRequests.get(client);
                        ...
                        if (dataBaseSystem.searchForUser(driver))
                            while (true){
                                ...
                                if(driverChoice1 == 1){ // show favourite places
                                    ...
                                    Ride ride=driver.requestedRides.get(rideNumber-1);
